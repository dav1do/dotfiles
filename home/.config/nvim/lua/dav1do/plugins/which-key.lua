return {
  ...
  config = function(_, opts)
    ...
    wk.add({
      ...
      { "<leader>Wo", desc = "close all other splits (<C-w>o)" },
      ...
      -- ── g / ] / [ / @ groups ───────────────────────────────────────────────
      {
        ...
        { "z",  group = "fold" },
        { "za", desc = "toggle fold" },
        { "zO", desc = "open fold + nested" }, { "zc", desc = "close fold" }, { "zC", desc = "close fold + nested" },
        { "zr", desc = "reveal one level" },   { "zR", desc = "reveal all" },
        { "zm", desc = "mask one level" },     { "zM", desc = "mask all" },
        { "]",  group = "next" },
        { "[",  group = "prev" },
        { "]t", desc = "next tab" },
        { "[t", desc = "prev tab" },
