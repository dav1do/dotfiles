return {
  {
    ...
    opts = {
      ...
      on_attach = function(bufnr)
        ...
        map('v', '<leader>ls', function() gitsigns.stage_hunk({ vim.fn.line('.'), vim.fn.line('v') }) end, { desc = "Stage hunk" })
        ...
        map('n', '<leader>lB', function() gitsigns.blame_line { full = true } end, { desc = "Blame line (full)" })
      end,
    },
  }
}
